...
container.sounds.Add(SoundSet("spree_unstoppable", ["audio/spree_unstoppable.wv"]))
container.sounds.Add(SoundSet("spree_godlike", ["audio/spree_godlike.wv"]))
...
#Assa
image_entities = Image("entities", "entities.png")
image_background = Image("background", "background.png")
...
#Assa
container.images.Add(image_entities)
container.images.Add(image_background)
