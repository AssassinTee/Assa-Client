...
class CMenus : public CComponent
{
	...
	*/
	...
	void RenderServerbrowserClan(CUIRect View);
	...
	void RenderSettingsSpecial(CUIRect MainView);
	void ColorSetting(CUIRect MainView);
	//Assa
	...
	void RenderSettingsBack(CUIRect MainView);

	//Teecomp
	void RenderRgbSliders(CUIRect* pMainView, CUIRect* pButton, int &r, int &g, int &b, bool Enabled);
	void RenderRgbaSliders(CUIRect* pMainView, CUIRect* pButton, int &r, int &g, int &b, int &a, bool Enabled);//Assa
...
public:
	...
	//Assa needed
	static void SetColorVar(int *r, int *g, int *b, int *var);
};
#endif
