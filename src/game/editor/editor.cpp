...
#include <game/client/components/entskins.h>
...
void CEditor::Render()
{
	ms_EntitiesTexture = g_pData->m_aImages[IMAGE_ENTITIES].m_Id;
	// basic start
...
{
	int Ent = g_pData->m_aImages[IMAGE_ENTITIES].m_Id;
	m_pGameLayer = (CLayerGame *)pLayer;
	m_pGameLayer->m_pEditor = m_pEditor;
	m_pGameLayer->m_TexID = Ent;
}
...
{
	EntitiesTexture = g_pData->m_aImages[IMAGE_ENTITIES].m_Id;
...
void CEditor::Init()
{
	...
	ms_CursorTexture = g_pData->m_aImages[IMAGE_CURSOR].m_Id;
	//ms_CursorTexture = Graphics()->LoadTexture("editor/cursor.png", IStorage::TYPE_ALL, CImageInfo::FORMAT_AUTO, 0);
	//ms_EntitiesTexture =  Graphics()->LoadTexture("entities/!default.png", IStorage::TYPE_ALL, CImageInfo::FORMAT_AUTO, 0);
	ms_EntitiesTexture = g_pData->m_aImages[IMAGE_ENTITIES].m_Id;
