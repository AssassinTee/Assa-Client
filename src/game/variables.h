...
MACRO_CONFIG_INT(ClSpreesounds, cl_spreesounds, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Turnes spreesounds on or off")
...
MACRO_CONFIG_INT(UiColor, ui_color_color, 1638266, 0, 4294967296, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Interface color")//huge limit 255^4//4 294 967 296
...
//dummy client (felix' request)
MACRO_CONFIG_STR(ClDummyPlayerName, cl_dummy_playername, 256, "Dummy", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy Name")
MACRO_CONFIG_STR(ClDummyPlayerClan, cl_dummy_playerclan, 256, "Dummy", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy Clan")
MACRO_CONFIG_STR(ClDummyPlayerSkin, cl_dummy_playerskin, 256, "default", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy Skin")
MACRO_CONFIG_INT(ClDummyColorBody, cl_dummy_colorbody, 65408, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy Colorbody")
MACRO_CONFIG_INT(ClDummyColorFeet, cl_dummy_colorfeet, 65408, 0, 0xFFFFFF, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy Colorfeet")
MACRO_CONFIG_INT(ClDummyUseCustomColor, cl_dummy_usecustomcolor, 0, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy Use Custom Color")

															// erstes leerzeichen macht der server automatisch, daher nicht nötig
MACRO_CONFIG_STR(ClDummyLeavemsg, cl_dummy_leavemsg, 1024, "~ Assa ~ ", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Dummy Leavemsg")

MACRO_CONFIG_INT(ClAutoReconnect, cl_auto_reconnect, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "State of Auto reconnect")
MACRO_CONFIG_INT(ClScoreboardScroll, cl_scoreboard_scroll, 3, 1, 16, CFGFLAG_CLIENT | CFGFLAG_SAVE, "State of Auto reconnect")
