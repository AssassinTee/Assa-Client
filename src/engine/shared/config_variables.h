...
MACRO_CONFIG_INT(ClDownloadSegments, cl_download_segments, 128, 1, 1024, CFGFLAG_SAVE|CFGFLAG_CLIENT, "How much segments should be downloaded at the same time but it could get difficult")
...
MACRO_CONFIG_INT(BrClanFindOwn, br_filter_own_clan, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Find own clan Members")
MACRO_CONFIG_STR(BrClanFindName, br_filter_clan_name, 25, "", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Find the Clan Members of the clan you tiped in")

//Assa
MACRO_CONFIG_INT(BrSpecialScore, br_special_score, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Show playerscore")//Why the fuck did i start all with BR?

MACRO_CONFIG_STR(BrSpecialDynBind, br_special_dyn_bind, 1, "", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Find the Clan Members of the clan you tiped in")
MACRO_CONFIG_INT(BrSpecialBlood, br_special_blood, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Bloodcolor")
MACRO_CONFIG_INT(BrSpecialRedBlood, br_special_red_blood, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Bloodcolor")
MACRO_CONFIG_INT(BrSpecialColorBlood, br_special_color_blood, 16739179, 0, 16777215, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Bloodcolor")
MACRO_CONFIG_INT(BrSpecialNameplateColor, br_special_nameplate_color, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Color nameplates in non-team mods")
MACRO_CONFIG_INT(BrSpecialWall, br_special_wall, 0, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Wallhack")
MACRO_CONFIG_INT(BrSpecialWallTiles, br_special_wall_tiles, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Wallhack")
MACRO_CONFIG_INT(BrSpecialWallQuads, br_special_wall_quads, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Wallhack")
MACRO_CONFIG_INT(BrSpecialWallColorQuads, br_special_wall_color_quads, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Wallhack")
MACRO_CONFIG_INT(BrSpecialWallColor, br_special_wall_color, 16739179, 0, 16777215, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Wallhack")
MACRO_CONFIG_INT(BrSpecialWallSolid, br_special_wall_solid, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Wallhack")

MACRO_CONFIG_INT(BrSpecialKillMessage, br_special_kill, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Kill-messages on/off")
MACRO_CONFIG_INT(BrSpecialKillMark, br_special_mark_kill, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Kill color on/off")
MACRO_CONFIG_INT(BrSpecialKillMarkColor, br_special_mark_kill_color, 65280, 0, 16777215, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Killmark color")
MACRO_CONFIG_INT(BrSpecialKillMarkD, br_special_assa_death, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Death color on/off")
MACRO_CONFIG_INT(BrSpecialKillMarkDColor, br_special_mark_death_color, 16711680, 0, 16777215, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Deathmark color")

MACRO_CONFIG_INT(BrSpecialKillAssa, br_special_assa, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Assa-messages on/off")
MACRO_CONFIG_INT(BrSpecialKillAssaColor, br_special_assa_color, 16776960, 0, 16777215, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Assa-message color")

MACRO_CONFIG_INT(BrSpecialFlagTimer, br_special_flag_timer, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Assa-messages on/off")
MACRO_CONFIG_INT(BrSpecialTime, br_special_time, 1, 0, 2, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Enables Clock: 1 = Digital, 2 = Analog")
MACRO_CONFIG_INT(BrSpecialTimeUi, br_special_time_ui, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Enables Clock: 1 = Digital, 2 = Analog")

//Cys
MACRO_CONFIG_INT(ClRoundingInt, cl_rounding_int, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Enables RoundingInt")
MACRO_CONFIG_INT(ClRounding, cl_rounding, 10, 0, 20, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Enables RoundingInt")


MACRO_CONFIG_INT(ScoreboardNatural, cl_scoreboard_natural, 0, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "changes Scoreboard-Scrolling")
...
//Assa Texture Changer
MACRO_CONFIG_STR(GameEntities, entities_texture, 24, "default", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Entities texture")
MACRO_CONFIG_STR(GameBack, background_texture, 24, "default", CFGFLAG_CLIENT|CFGFLAG_SAVE, "BG texture")
MACRO_CONFIG_STR(GameFontfile, font_texture, 255, "DejaVuSans.ttf", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Font texture")
